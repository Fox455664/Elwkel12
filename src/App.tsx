...
// ❌ تم حذف السطر التالي لأنه يسبب المشكلة والملف غير موجود
// import { Toaster } from "@/components/ui/toaster"; 

// ✅ سنعتمد على Sonner فقط (وهو الأفضل)
...
import RegisterTruckPage from "./pages/driver/RegisterTruckPage";
import AddSubDriverPage from "./pages/driver/AddSubDriverPage";
...
const App = () => {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        {/* ❌ تم حذف <Toaster /> لأنه غير موجود */}
        
        {/* ✅ هذا يكفي لعرض التنبيهات */}
        <Sonner />
